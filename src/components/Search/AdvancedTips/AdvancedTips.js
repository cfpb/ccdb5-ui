        ...
        >
          ...
          <div className="tips">
            ...
            <div className="tip">
              ...
              />
              <div className="tip-description">
                <p>Use + if the search must contain the term</p>
                <p>Use - if the search must not contain the term</p>
              </div>
            </div>
            <div className="tip">
              ...
              <label className="u-visually-hidden" htmlFor="example-proximity">
                ...
                characters from one another; the words should be in quotation
                marks
              </label>
              <input
            ...
            <div className="tip">
              ...
              <label className="u-visually-hidden" htmlFor="example-fuzzy">
                Use ~ to search for terms that are similar to your keyword term
                to catch spelling errors. Note that this only works with single
                words (not phrases)
              </label>
              <input
                className="a-text-input example-input_full"
              ...
              <div className="tip-description">
                <p>
                  Use ~ to search for terms that are similar to your keyword
                  term to catch spelling errors. Note that this only works with
            ...
            <div className="tip">
              ...
              <label className="u-visually-hidden" htmlFor="example-boost">
                Use ^2 after a term to boost its relevance above the other term
              </label>
              <input
                className="a-text-input example-input_full"
                id="example-boost"
              ...
              <div className="tip-description">
                <p>
                  Use ^2 after a term to boost its relevance above the other
                  term
                </p>
              </div>
            </div>
