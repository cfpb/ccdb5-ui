...
describe('Tile map', () => {
  ...
  it('formats the map tooltip w/ prod & issue', () => {
    ...
    const result = sutClone.tooltipFormatter();
    expect(result).toEqual(
      '<h4 class="title">Florida (FL)</h4><div class="row row--count"><p class="u-float-left">Complaint count</p><p class="u-right">10,000</p></div><div class="row row--count-mobile"><p class="u-right">10,000 complaints</p></div><div class="row row--product"><p class="u-float-left">Product with highest complaint volume</p><p class="u-right">Expensive Item</p></div><div class="row row--issue"><p class="u-float-left">Issue with highest complaint volume</p><p class="u-right">Being Broke</p></div>',
    );
  });
