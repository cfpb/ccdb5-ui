...
export default class MoreAbout extends React.Component {
  render() {
    ...
    const urlCriteria = 'https://files.consumerfinance.gov/f/documents/' +
      ...
      <section className="more-about-modal">
        ...
        <div className="body">
          <p className="body-copy">
            This database only includes complaints the CFPB sent to companies
            and complaints are only published after the company responds,
            confirming a commercial relationship or after 15 days, whichever
            comes first. This database does not include complaints referred to
            other regulators, such as complaints about depository institutions
          ...
          <p className="body-copy">
            This database only includes a consumer’s description of what
            happened in their own words if the consumer agrees to share it and
            after we take steps to&nbsp;
            <a href={urlScrubbing}
              target="_blank"
