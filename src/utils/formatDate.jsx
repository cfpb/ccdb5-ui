 ...
 */
export const formatDate = uglyDate => dayjs( new Date( uglyDate ) ).format( 'YYYY-MM-DD' );
 ...
 */
export const adjustDate = dateIn => dayjs( new Date( dateIn ) ).utc().add( 5.5, 'hours' ).format();
 ...
 * @returns {string} the cleaned up string in YYYY-MM-DD
 */
export const formatDateModel = dateIn => dayjs( new Date( dateIn ) ).utc().add( 5.5, 'hours' ).format( 'YYYY-MM-DD' );
 ...
 */
export const formatDateLocaleShort = dateIn => dayjs( new Date( dateIn ) ).utc().add( 5.5, 'hours' ).format( 'll' );
 ...
 */
export const isDateEqual = ( a, b ) => dayjs( new Date( a ) ).isSame( new Date( b ), 'day' );
