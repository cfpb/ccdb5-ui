...
import { createCharts } from 'cfpb-chart-builder';
...
export class TileChartMap extends React.Component {
  ...
  componentDidMount() {
    ...
    //   el: document.getElementById('mymap'),
    //   source: 'mortgage-performance/meta/us-metros.geo.json',
    //   // https://files.consumerfinance.gov/data/mortgage-performance/meta/us-metros.geo.json
    //   type: 'tile_map'
    // } );
    createCharts();
  }
