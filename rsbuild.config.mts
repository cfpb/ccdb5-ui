...
// Nested GitHub Pages previews set BASE_PATH, e.g. /ccdb5-ui/pr-previews/pr-12/
const basePath = process.env.BASE_PATH || '/';
// Preview builds need an absolute API host; local/cfgov embeds use a relative path.
const apiBase =
  process.env.CCDB_API_BASE ||
